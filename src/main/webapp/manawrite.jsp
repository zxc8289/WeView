...
<tr>
	<th rowspan="5">
	 <div class="select_img" align="center">
 		<img src="" />
 		<label class="array">이미지 추가<input type="file" id="poster" name="file"  onchange="changeValue(this)"  style="display: none;"/></label>
 		<!-- <button type="button"  class="btn btn-light" id="btn-upload">이미지 추가</button> -->
 	</div>
 	</th>
	<td colspan="2">
		<input type="text" name="title" size="27px" placeholder="영화 제목">
	</td>
	<td colspan="1">
...
<tr>
	...
	<td>
		<input type="text" name="created" size="10px" placeholder="개봉일자">
	</td>
</tr>
...
<tr>
	<td colspan="4">
		<input type="text" name="actor" size="50px" placeholder="배우">
	</td>
</tr>	

<tr>
	<td colspan="4">
		<input type="text" name="trailer" size="50px" placeholder="예고편">
	</td>
</tr>	

 <tr>
	<td colspan="5">
		<textarea rows="5" cols="105" name="story" placeholder="줄거리"></textarea>
	</td>
</tr>
